...
public class FundingFilterTests
{
    ...
    private static (ArbitrageScanner Scanner, FakeConnector Long, FakeConnector Short, FakeExecutor Executor, BotOptions Options) Create()
    {
        ...
        return (scanner, longConnector, shortConnector, executor, options);
    }
    ...
    {
        var (scanner, longConnector, shortConnector, executor, _) = Create();
    ...
    {
        var (scanner, _, _, executor, _) = Create();
    ...
    {
        var (scanner, longConnector, shortConnector, executor, options) = Create();
